<%-- 
    Document   : lastDispo
    Created on : May 12, 2019, 12:20:30 AM
    Author     : Judith
--%>
...
<fmt:bundle basename="app">
    ...
    <html>
        <head>
            <title>IkeyPro - Shop -      <c:forEach var = "ligne" items="${ListeProdLastDispo}">
                    <c:choose>
                        <c:when test="${ligne.codeProduit==param.lastProd}"> 
                            ${ligne.produit}
                        </c:when>
                    </c:choose>
                </c:forEach></title>
            ...
            <div class="super_container">
                ...
                <div class="home">
                    ...
                    <div class="home_content d-flex flex-column align-items-center justify-content-center">
                        <h2 class="home_title">      
                            <c:forEach var = "ligne" items="${ListeProdLastDispo}">
                                <c:choose>
                                    <c:when test="${ligne.codeProduit==param.lastProd}"> 
                                        ${ligne.produit}
                                    </c:when>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="shop_sidebar">
                                    <div class="sidebar_section filter_by_section">
                                        <div class="sidebar_title"><fmt:message key="PFilterBy"/></div>
                                        <div class="sidebar_subtitle"><fmt:message key="PPrice"/></div>
                                    ...
                                    <div class="sidebar_section">
                                        <div class="sidebar_subtitle brands_subtitle"><fmt:message key="PBrands"/></div>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="shop_content">
                                    <div class="shop_bar clearfix">
                                        <div class="shop_product_count"><span>${ListeProdEdition.size()}</span> <fmt:message key="PProductsFound"/></div>
                                        <div class="shop_sorting">
                                            <span><fmt:message key="PSortBy"/>:</span>
                                            <ul>
                                                <li>
                                    ...
                                    <div class="product_grid">
                                        ...
                                        <!-- Product Item -->
                                        <c:forEach var = "ligne" items="${ListeProdEdition}">
                                            <!-- Product Item -->
                                            <div class="product_item is_new">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <div class="product_name"><div>${ligne.edition}</div></div>
