                            ...
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="single_post_text">
                                    ...
                                    <div class="single_post_quote text-center">
                                        ...
                                        <div class="quote_name">CONFIRMATION</div>
                                        <div class="quote_text"> <b>Statut:</b> ${st}</div>
                                        <div class="quote_text"><b>Montant:</b> ${amt}${cc}</div>
                                        <div class="quote_text"><b>No Réference:</b> ${tx}</div>
