    ...
    <html>
        <head>
            <title>IkeyPro - Shop -      <c:forEach var = "ligne" items="${ListeEditeurs}">
                    <c:choose>
                        <c:when test="${ligne.id_Editeur==param.edit}"> 
                            ${ligne.editeur}
                        </c:when>
                    </c:choose>
                </c:forEach></title>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="book_tabel_item py-3 px-2">
                                                        ...
                                                        <div class="input-group  d-flex justify-content-center">
                                                            <select name="editeur2" class="wide" id="des" required><option>--Choisir--</option> </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="book_tabel_item py-3 px-2">
                                                        ...
                                                        <div class="input-group  d-flex justify-content-center">
                                                            <select name="edition2" class="wide" id="dur" required><option>--Choisir--</option></select>
                                                        </div>
                                                    </div>
                                                </div>
